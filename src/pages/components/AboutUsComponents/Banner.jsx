  ...
  return (
    <div className="flex flex-col-reverse lg:flex-row lg:justify-between lg:items-center py-20 px-3 md:px-5 lg:px-0">
      ...
      <div className="lg:flex-1">
        ...
        <div className="w-2/3 md:w-2/5 lg:w-1/2 h-56 md:h-60 lg:h-72 border-4 border-[rgb(36,132,121)] absolute z-0 top-8 lg:top-5 left-14 md:left-60 lg:left-40 rounded-3xl"></div>
        <img
