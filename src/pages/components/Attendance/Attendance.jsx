...
const Attendance = () => {
    ...
    return (
        <div>
           ...
           <div className="border-2 border-[#D9D9D9] p-7 rounded-md space-y-5">
                ...
                <h1 className="text-base  md:text-xl font-medium text-center ">developerashrafulislamrifaz@gmali.com</h1>
