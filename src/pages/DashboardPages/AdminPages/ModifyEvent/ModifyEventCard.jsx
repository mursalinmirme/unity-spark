...
const ModifyEventCard = ({items , handleDelete , handlemodalopen}) => {
    ...
    return (
        ...
        <IoIosArrowDropdown className={`absolute top-7 text-2xl font-medium right-2 transition-all duration-300 ${isOpen ? "rotate-180" : "rotate-0"}`}
         onClick={() => setisOpen(!isOpen)}/>
        <h1 className="font-semibold text-[23px] p-5 pr-10">{items?.eventName}</h1>
