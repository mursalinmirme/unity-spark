            ...
            <div className="border-2 border-[#D9D9D9] p-5 rounded-lg">
                ...
                <div>
                    ...
                    <div className="grid grid-cols-2 gap-5 mt-5">
                        <input type="text" defaultValue={title} placeholder="Course name" {...register("course_name")} />
                ...
                <div>
                    ...
                    <div className="grid grid-cols-2 gap-5">
                        <input defaultValue={instructor_name} {...register("instructor_name")} type="text" placeholder="Instructor name" />
                    ...
                    <div className="mt-4">
                        <input defaultValue={instructor_bio} {...register("instructor_bio")} type="text" placeholder="Instructor bio" />
                    </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="grid grid-cols-2 gap-5">
                        <input defaultValue={intro} {...register("intro_video")} type="text" placeholder="Intro video link" />
                ...
                <button onClick={handleSubmit(onSubmit)} type="submit" className="px-3.5 md:px-5 py-2 bg-[#433EBE] text-white text-base font-semibold mt-4 rounded-lg">Update</button>
            </div>
        </div>
    );
};
