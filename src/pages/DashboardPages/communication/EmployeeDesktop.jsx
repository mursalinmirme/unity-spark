...
const EmployeeDesktop = ({remainingEmployees, setSearchValue, searchValue, searchedEmployees, setSelectedUserEmail, setSelectedChat, selectedChat, sortedEmployees}) => {
    const [showSearchBar, setShowSearchBar] = useState(false);

    return (
        <div className={`col-span-1 md:col-span-3 lg:col-span-2 bg-white p-2 rounded-lg overflow-y-hidden flex flex-col`} style={{height: 'calc(100% - 2px)'}}>
            <div className="h-14">
