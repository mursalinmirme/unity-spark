...
const ChatForPhone = ({onSubmit, register, handleSubmit, selectedEmployee, showChat, setShowChat, messages, user}) => {
    
    return (
        <div className={` relative overflow-y-hidden flex flex-col justify-between ${showChat ? "block" : "hidden md:block"}`} style={{height: 'calc(100% - 2px)'}}>
            <div className="h-20">
